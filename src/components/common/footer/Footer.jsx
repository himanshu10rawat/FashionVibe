...
export default function Footer() {
  return (
    <footer className="bg-gray-100 p-5 md:px-20 md:py-10 mb-15 md:mb-0">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 border-b border-gray-300 pb-5">
        <div>
          <h2 className="text-black uppercase font-semibold text-lg mb-2 md:mb-4">
            <Link href={"/online-shopping"}>online shopping</Link>
          </h2>
          <p className="text-gray-500 capitalize md:text-lg mb-1 md:mb-2 transition-colors duration-300 ease-in-out hover:text-black">
        ...
        <div>
          ...
          <p className="text-gray-500 uppercase md:text-lg mb-1 md:mb-2 transition-colors duration-300 ease-in-out hover:text-black">
      ...
      <div className="pt-5 flex justify-between flex-wrap gap-3 md:gap-5">
        <span className="md:text-lg text-gray-500">
