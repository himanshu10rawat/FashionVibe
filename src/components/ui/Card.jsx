...
export default function Card() {
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5">
      <div className="relative h-60 md:h-150 after:content-[''] after:absolute after:bg-black/25 after:inset-0 after:w-full after:h-full">
        <Image
        ...
        <div className="absolute bottom-0 left-0 p-4 md:p-10 text-white z-10">
          ...
          <p className="mb-2 font-semibold md:text-lg capitalize">50-80% off</p>
      ...
      <div className="relative h-60 md:h-150 after:content-[''] after:absolute after:bg-black/25 after:inset-0 after:w-full after:h-full">
        ...
        <div className="absolute bottom-0 left-0 p-4 md:p-10 text-white z-10">
          ...
          <p className="mb-2 font-semibold md:text-lg capitalize">40-80% off</p>
          <button className="bg-white text-black font-semibold border-0 px-5 py-2.5 capitalize transition-color duration-300 hover:bg-black hover:text-white cursor-pointer ease-in-out text-sm md:text-lg">
            explore now
          </button>
        </div>
      ...
      <div className="relative h-60 md:h-150 after:content-[''] after:absolute after:bg-black/25 after:inset-0 after:w-full after:h-full">
        ...
        <div className="absolute bottom-0 left-0 p-4 md:p-10 text-white z-10">
          ...
          <p className="mb-2 font-semibold md:text-lg capitalize">30-80% off</p>
          <button className="bg-white text-black font-semibold border-0 px-5 py-2.5 capitalize transition-color duration-300 hover:bg-black hover:text-white cursor-pointer ease-in-out text-sm md:text-lg">
            explore now
          </button>
        </div>
